      ...
      Program: {
        exit(path) {
          ...
          function addRequire(source, blockHoist) {
            ...
            const requireExpr = buildRequire(t.stringLiteral(source)).expression
            requireExpr._convertedFromImport = true
            const varDecl = t.variableDeclaration("const", [
              t.variableDeclarator(ref, requireExpr)
            ]);
          ...
          for (const source in imports) {
            ...
            if (specifiers.length) {
              ...
              requireNode.expression._convertedFromImport = true
